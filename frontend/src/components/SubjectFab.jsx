...
const ModalButton = styled.button`
  border: 1px solid ${({ secondary, theme }) => (secondary ? theme.borderColor : "transparent")};
  cursor: pointer;
  padding: 10px 15px;
  border-radius: 9px;
  color: ${({ secondary, theme }) => (secondary ? theme.text : theme.onAccent)};
  font-weight: 600;
        ...
        {isModalOpen ? (
          ...
          >
            ...
            >
              ...
              />
              <ModalActions>
                <ModalButton as={motion.button} whileTap={{ scale: 0.97 }} type="button" secondary onClick={() => setIsModalOpen(false)}>
                  Cancel
                </ModalButton>
                <ModalButton as={motion.button} whileTap={{ scale: 0.97 }} type="submit" disabled={creatingSubject}>
                  {creatingSubject ? (
